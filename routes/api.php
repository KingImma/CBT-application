...
/*
|--------------------------------------------------------------------------
| CENTRAL DOMAIN ROUTES (Super Admin & Public Onboarding)
| Hit via: http://myapp.local/api/...
|--------------------------------------------------------------------------
*/
Route::domain($centralDomain)->group(function () {
    
    // Unified Frontend Login Endpoint (Central)
...
/*
|--------------------------------------------------------------------------
| TENANT DOMAIN ROUTES (Schools)
| Hit via: http://{handle}.myapp.local/api/...
|--------------------------------------------------------------------------
*/
// Note: We leave the domain wildcard to Stancl's middleware to parse
Route::middleware([InitializeTenancyByHandle::class])->group(function () {

    // Unified Frontend Login Endpoint (Tenant)
    // The database is successfully swapped before the controller runs!
