...
class AutoSubmitExpiredExams extends Command
{
    ...
    public function handle(): int
    {
        ...
        $individualExpired = ExamAttempt::where('status', ExamAttemptStatus::In_progress->value)
        ...
        $sessionExpired = ExamAttempt::where('status', ExamAttemptStatus::In_progress->value)
