...
Route::get('academic-sessions', [AcademicSessionController::class, 'index'])->middleware('role:teacher|school_admin,tenant');
Route::get('academic-sessions/{academicSession}', [AcademicSessionController::class, 'show'])->middleware('role:teacher|school_admin,tenant');
Route::get('academic-sessions/{sessionId}/terms', [TermController::class, 'index'])->middleware('role:teacher|school_admin,tenant');
