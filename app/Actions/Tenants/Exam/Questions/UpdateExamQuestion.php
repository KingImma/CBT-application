...
class UpdateExamQuestion
{
    ...
    public function execute(Exam $exam, Question $question, UpdateExamQuestionData $data): ExamQuestion
    {
        ...
        return DB::transaction(fn () => $this->performUpdate($exam, $question, $data));
    }
    ...
    private function performUpdate(Exam $exam, Question $question, UpdateExamData $data): ExamQuestion
    {
