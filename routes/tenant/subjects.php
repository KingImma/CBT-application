...
Route::get('subjects', [SubjectController::class, 'index'])->middleware('role:teacher|school_admin,tenant');
Route::get('subjects/{subject}', [SubjectController::class, 'show'])->middleware('role:teacher|school_admin,tenant');
