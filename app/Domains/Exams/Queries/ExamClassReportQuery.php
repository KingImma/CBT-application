...
/** Read-only query â€” loads students + latest graded attempt per student in one pass. */
final class ExamClassReportQuery
{
    public function execute(ClassArm $arm, Exam $exam): object
    {
        ...
        // DISTINCT ON (student_id) â†’ latest completed attempt per student, single query
