...
class SchoolSettingController extends Controller
{
    ...
    public function assessments(): JsonResponse
    {
        ...
        return ApiResponse::success(
            [
                "assessment_max_score" =>
                    (int) ($settings["assessment_max_score"] ?? 50),
    ...
    public function assessmentDefaults(): JsonResponse
    {
        return ApiResponse::success(
            [
                "duration_minutes" =>
                    (int) (SchoolSetting::value("default_duration_minutes") ??
                        120),
                "max_attempts" =>
                    (int) (SchoolSetting::value("default_max_attempts") ?? 1),
                "show_result_immediately" => filter_var(
                    SchoolSetting::value("default_show_result_immediately") ??
                        false,
                    FILTER_VALIDATE_BOOLEAN,
                ),
                "pass_mark" =>
                    (float) (SchoolSetting::value("default_pass_mark") ?? 50),
            ],
