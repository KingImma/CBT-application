...
final class TrueFalseResultQuestionData extends ResultQuestionData
{
    /** @var array<int, array{id: string, label: ?string, content: string, content_format: string, is_correct: bool}> */
