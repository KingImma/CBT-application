...
class QuestionController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        $questions = Question::with(['topic', 'classLevel', 'creator:id,first_name,last_name'])
            ...
            ->when($request->search, fn ($q) =>
                $q->where('content', 'ilike', "%{$request->search}%")
            )
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        if ($typeError) {
            return response()->json(['success' => false, 'message' => $typeError], 422);
        }
        ...
        return response()->json([
            ...
            'data'    => $question->load(['options', 'fillBlankAnswers', 'topic', 'classLevel']),
        ], 201);
    }
    ...
    public function update(Request $request, string $id): JsonResponse
    {
        ...
        return response()->json([
            ...
            'data'    => $question->fresh(['options', 'fillBlankAnswers', 'topic']),
        ]);
    }
    ...
    public function destroy(string $id): JsonResponse
    {
        ...
        return response()->json(['success' => true, 'message' => 'Question archived.']);
    }
